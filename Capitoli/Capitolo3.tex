...
In Figura \ref{weblistfigure} vengono mostrate le liste Web, usate per guidare il processo di Crawling. I link inseriti nel box $A$  sono stati esclusi perché il loro dominio è differente da quello della homepage. Il risultato del Crawler che sfrutta le liste Web è un sottografo $G' = (V', E')$, dove $V' \subseteq V$ ed $E' \subseteq E$.
