...
\begin{enumerate}
	...
	\item Verificare che, se analizzando la topologia del grafo del sito Web e dando più importanza a pagine vicino alla homepage, si ottengono risultati migliori rispetto all'approccio che analizza tutte le pagine come ugualmente importanti. La modifica applicata verrà discussa nella Sezione \ref{modifiedSkipgram}.
\end{enumerate}