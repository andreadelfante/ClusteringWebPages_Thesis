...
\\
Nel capitolo 1 ci si occuperà di descrivere i concetti essenziali per comprendere a pieno il campo applicativo in cui verrà effettuata la sperimentazione.
Nel capitolo 2 si parlerà della frontiera attuale dell'Informatica in questo campo, descrivendo i risultati dei lavori correlati a quello descritto in questa tesi.
...
Nel capitolo 4 si descriverà la sperimentazione effettuata, spiegando le metriche utilizzate, le configurazioni utilizzate e riportando le tabelle con i risultati utili per spiegare i valori ottenuti.
Nel capitolo 5, infine, si parlerà dei possibili sviluppi futuri di questa attività di ricerca.