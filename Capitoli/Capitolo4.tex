...
\\\\
L'obiettivo è quello di valutare l'efficacia dell'approccio realizzato per poter comprendere se la modifica del modello di Word2Vec Skip-Gram può portare ad un miglioramento effettivo del processo di Clustering delle pagine di un sito Web.
\\
