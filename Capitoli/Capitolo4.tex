...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|l|l|}
		...
		\textbf{Stanford} & 167 & 30087 & 12372 & 10 \\ \hline
	\end{tabular}
\end{table}
...
\label{doc2vectfidfillinois}
	\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|}
		\hline
		& \textbf{Clustering} & \textbf{AMI} & \textbf{ARI} & \textbf{Com} & \textbf{Hom} & \textbf{Silh} & \textbf{V-M} \\ \hline
		\textbf{Doc2Vec} & \textbf{KMeans} & 0.52 & 0.33 & 0.54 & 0.71 & -0.09 & 0.61 \\ \hline
		\textbf{Doc2Vec} & \textbf{HDBScan} & \textbf{0.76} & \textbf{0.83} & \textbf{0.78} & 0.77 & -0.03 & \textbf{0.77} \\ \hline
		\textbf{TF-IDF} & \textbf{KMeans} & 0.62 & 0.43 & 0.63 & \textbf{0.84} & \textbf{-0.02} & 0.72 \\ \hline
		\textbf{TF-IDF} & \textbf{HDBScan} & 0.54 & 0.40 & 0.57 & 0.69 & -0.07 & 0.62 \\ \hline
	\end{tabular}
\end{table}

Come nella configurazione precedente, pur trattando le pagine del sito Illinois come semplici documenti, si riescono ad estrapolare dal testo informazioni più significative con \textbf{Doc2Vec}, utilizzate in maniera più efficace da  \textbf{HDBScan} (Tabella \ref{doc2vectfidfillinois}).
...
\hline
& \textbf{Clustering} & \textbf{AMI} & \textbf{ARI} & \textbf{Com} & \textbf{Hom} & \textbf{Silh} & \textbf{V-M} \\ \hline
\textbf{Doc2Vec} & \textbf{KMeans} & 0.45 & 0.36 & 0.46 & 0.54 & -0.14 & 0.50 \\ \hline
\textbf{Doc2Vec} & \textbf{HDBScan} & 0.35 & 0.06 & 0.43 & 0.39 & -0.30 & 0.40 \\ \hline
\textbf{TF-IDF} & \textbf{KMeans} & \textbf{0.60} & \textbf{0.53} & \textbf{0.61} & \textbf{0.73} & \textbf{-0.00} & \textbf{0.67} \\ \hline
\textbf{TF-IDF} & \textbf{HDBScan} & 0.45 & 0.20 & 0.49 & 0.48 & -0.20 & 0.48 \\ \hline
\end{tabular}
\end{table}
...
\hline
& \textbf{Clustering} & \textbf{AMI} & \textbf{ARI} & \textbf{Com} & \textbf{Hom} & \textbf{Silh} & \textbf{V-M} \\ \hline
\textbf{Doc2Vec} & \textbf{KMeans} & 0.47 & 0.43 & 0.47 & 0.57 & -0.04 & 0.52 \\ \hline
\textbf{Doc2Vec} & \textbf{HDBScan} & 0.41 & 0.26 & 0.44 & 0.50 & -0.38 & 0.47 \\ \hline
\textbf{TF-IDF} & \textbf{KMeans} & \textbf{0.57} & \textbf{0.68} & \textbf{0.58} & \textbf{0.71} & \textbf{0.05} & \textbf{0.64} \\ \hline
\textbf{TF-IDF} & \textbf{HDBScan} & 0.30 & 0.16 & 0.33 & 0.38 & -0.32 & 0.36 \\ \hline
\end{tabular}
\end{table}
...
\hline
& \textbf{Clustering} & \textbf{AMI} & \textbf{ARI} & \textbf{Com} & \textbf{Hom} & \textbf{Silh} & \textbf{V-M} \\ \hline
\textbf{Doc2Vec} & \textbf{KMeans} & 0.24 & 0.08 & 0.36 & 0.33 & -0.32 & 0.34 \\ \hline
\textbf{Doc2Vec} & \textbf{HDBScan} & 0.13 & 0.07 & 0.34 & 0.18 & -0.14 & 0.23 \\ \hline
\textbf{TF-IDF} & \textbf{KMeans} & \textbf{0.35} & \textbf{0.13} & \textbf{0.47} & \textbf{0.44} & -0.30 & \textbf{0.45} \\ \hline
\textbf{TF-IDF} & \textbf{HDBScan} & 0.15 & 0.06 & 0.37 & 0.19 & \textbf{-0.07} & 0.25 \\ \hline
\end{tabular}
\end{table}

Analizzando solo il contenuto testuale delle pagine Web di Stanford, si evince dalla Tabella \ref{doc2vectfidfstanford} che \textbf{Tf-idf} con \textbf{KMeans} ha ottenuto le migliori performance, anche se i Cluster risultano non propriamente definiti (-0.30).
...
\textbf{Doc2Vec} & \textbf{HDBScan} & 0.76 & \textbf{0.83} & 0.78 & 0.77 & \textbf{-0.03} & 0.77 \\ \hline
\textbf{left-nc + TF-IDF} & \textbf{HDBScan} & \textbf{0.78} & 0.76 & \textbf{0.83} & 0.79 & \textbf{-0.03} & \textbf{0.81} \\ \hline
\end{tabular}
\begin{tabular}{|l|l|l|l|}
\hline
& \textbf{DB size} & \textbf{Window} & \textbf{RW len.} \\ \hline
\textbf{normal-nc} & 100K & 2 & 20 \\ \hline
\textbf{left-nc + TF-IDF} & \textbf{1M} & \textbf{2} & \textbf{20} \\ \hline
\end{tabular}
\end{table}
...
\textbf{TF-IDF} & \textbf{KMeans} & 0.60 & 0.53 & 0.61 & 0.73 & \textbf{-0.00} & 0.67 \\ \hline
\textbf{left-nc + TF-IDF} & \textbf{KMeans} & \textbf{0.68} & \textbf{0.60} & \textbf{0.68} & \textbf{0.80} & -0.04 & \textbf{0.74} \\ \hline
\end{tabular}
\begin{tabular}{|l|l|l|l|}
\hline
& \textbf{DB size} & \textbf{Window} & \textbf{RW len.} \\ \hline
\textbf{left-nc} & 1M & 5 & 20 \\ \hline
\textbf{left-nc + TF-IDF} & \textbf{1M} & \textbf{5} & \textbf{20} \\ \hline
\end{tabular}
\end{table}
...
\textbf{TF-IDF} & \textbf{KMeans} & \textbf{0.57} & \textbf{0.68} & \textbf{0.58} & 0.71 & \textbf{0.05} & \textbf{0.64} \\ \hline
\textbf{normal-nc + TF-IDF} & \textbf{KMeans} & 0.53 & 0.65 & 0.54 & \textbf{0.73} & -0.03 & 0.62 \\ \hline
\end{tabular}
\begin{tabular}{|l|l|l|l|}
\hline
& \textbf{DB size} & \textbf{Window} & \textbf{RW len.} \\ \hline
\textbf{normal-lc} & 1M & 5 & 10 \\ \hline
\textbf{normal-nc + TF-IDF} & 1M & 7 & 10 \\ \hline
\end{tabular}
\end{table}
...
\textbf{TF-IDF} & \textbf{KMeans} & 0.35 & 0.13 & 0.47 & 0.44 & -0.30 & 0.45 \\ \hline
\textbf{normal-lc + Doc2Vec} & \textbf{KMeans} & 0.46 & \textbf{0.27} & 0.54 & \textbf{0.53} & \textbf{-0.03} & 0.53 \\ \hline
\end{tabular}
\begin{tabular}{|l|l|l|l|}
\hline
& \textbf{DB size} & \textbf{Window} & \textbf{RW len.} \\ \hline
\textbf{normal-lc} & \textbf{1M} & \textbf{2} & \textbf{20} \\ \hline
\textbf{normal-lc + Doc2Vec} & 1M & 2 & 20 \\ \hline
\end{tabular}
\end{table}
...
A sostegno delle considerazioni finali fatte in precedenza, sono stati eseguiti i test di Wilcoxon e di Nemenyi.
\\
Wilcoxon è un test statistico usato per calcolare ed analizzare la differenza tra due modelli e capire se questa è statisticamente significativa. Viene calcolato il \textit{p-value}, un valore che viene usato per quantificare tale differenza. Se il valore p è minore di 0.05, allora la differenza tra i due modelli è statisticamente significativa. In Tabella \ref{wilcoxon} sono state riportate le configurazioni messe a confronto con i relativi p-value ottenuti. Tali configurazioni sono state raggruppate per metrica. I valori p che presentano una differenza statisticamente significativa sono stati evidenziati in grassetto. Inoltre, per ogni configurazione, sono stati riportati i modelli vincitori, i cui valori hanno permesso di ottenere una mediana più alta.
\\
Nemenyi è un test statistico simile al Wilcoxon, ma che permette di analizzare la differenza tra più di due modelli. Nella Figura \ref{nemenyi} si riportano i confronti effettuati tra normalSkipgram, leftSkipgram e LINE con secondo ordine di prossimità. Le configurazioni migliori vengono disposte sulla destra lungo un asse. Vengono considerate tutte le configurazioni a coppie. Se la coppia supera la critical distance prodotta dal test, allora significa che vi è una differenza statisticamente significativa. Tutte le configurazioni che non differiscono in maniera significativa sono collegate da una linea orizzontale.

\begin{figure}
	\centering
	\includegraphics[width = 140mm]{nemenyi}
	\caption{Test di Nemenyi}
	\label{nemenyi}
\end{figure}

\begin{table}[h]
\centering
\caption{Risultati del test di Wilcoxon}
\label{wilcoxon}
\begin{tabular}{lllll} \toprule
\textbf{Metrica} & \textbf{Configurazione} & \textbf{p-value} & \textbf{Vincitore} \\ \midrule
\textbf{AMI} & Combinato vs Struttura & \textbf{0.0031} & Combinato \\
& Combinato vs Testo & \textbf{0.0004} & Combinato \\
& Struttura vs Testo & 0.1443 & Testo \\
& LC vs NC & \textbf{0.0344} & LC \\
& KMeans vs HDBScan & \textbf{0.0000} & KMeans \\
& TF-IDF vs Doc2Vec & 0.2875 & TF-IDF \\ \midrule

\textbf{ARI} & Combinato vs Struttura & 0.4105 & Combinato \\
& Combinato vs Testo & \textbf{0.0050} & Combinato \\
& Struttura vs Testo & \textbf{0.0389} & Struttura \\
& LC vs NC & 0.0511 & LC \\
& KMeans vs HDBScan & \textbf{0.0000} & KMeans \\
& TF-IDF vs Doc2Vec & 0.2643 & TF-IDF \\ \midrule

\textbf{Com} & Combinato vs Struttura & \textbf{0.0117} & Combinato \\
& Combinato vs Testo & \textbf{0.0000} & Combinato \\
& Struttura vs Testo & \textbf{0.0065} & Struttura \\
& LC vs NC & \textbf{0.0034} & NC \\
& KMeans vs HDBScan & 0.2322 & KMeans \\
& TF-IDF vs Doc2Vec & 0.2641 & TF-IDF \\ \midrule

\textbf{Hom} & Combinato vs Struttura & \textbf{0.0153} & Combinato \\
& Combinato vs Testo & \textbf{0.0000} & Combinato \\
& Struttura vs Testo & \textbf{0.0019} & Struttura \\
& LC vs NC & 0.4154 & LC \\
& KMeans vs HDBScan & \textbf{0.0000} & KMeans \\
& TF-IDF vs Doc2Vec & 0.0707 & TF-IDF \\ \midrule

\textbf{Silh} & Combinato vs Struttura & 0.4759 & Struttura \\
& Combinato vs Testo & \textbf{0.0000} & Combinato \\
& Struttura vs Testo & \textbf{0.0000} & Struttura \\
& LC vs NC & 0.1467 & NC \\
& KMeans vs HDBScan & \textbf{0.0000} & KMeans \\
& TF-IDF vs Doc2Vec & \textbf{0.0150} & TF-IDF \\ \midrule

\textbf{V-M} & Combinato vs Struttura & \textbf{0.0115} & Combinato \\
& Combinato vs Testo & \textbf{0.0000} & Combinato \\
& Struttura vs Testo & \textbf{0.0067} & Struttura \\
& LC vs NC & 0.0586 & NC \\
& KMeans vs HDBScan & \textbf{0.0000} & KMeans \\
& TF-IDF vs Doc2Vec & 0.1811 & TF-IDF \\ \bottomrule
\end{tabular}
\end{table}